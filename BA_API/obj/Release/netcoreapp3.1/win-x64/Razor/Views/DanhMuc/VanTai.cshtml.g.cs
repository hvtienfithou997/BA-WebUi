#pragma checksum "D:\BA_Work\BA_API\BA_API\Views\DanhMuc\VanTai.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "01ee5ff27ab1834e1f9e716789880a4061bbc14d"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"01ee5ff27ab1834e1f9e716789880a4061bbc14d", @"/Views/DanhMuc/VanTai.cshtml")]
            ...
            <div class=""row"">
                ...
                <div class=""form-group col-xl-3 col-lg-6"">
                    ...
                    <select class=""form-control"" id=""department"" placeholder=""Sở GTVT"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "01ee5ff27ab1834e1f9e716789880a4061bbc14d4729", async() => {
            ...
            WriteLiteral(@"
                ...
                <div class=""form-group col-xl-3 col-lg-6"">
                    ...
                    <select class=""form-control"" id=""transportUnit"" placeholder=""Đơn vị vận tải"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "01ee5ff27ab1834e1f9e716789880a4061bbc14d6212", async() => {
            ...
            <div class=""modal-body mx-3"">
                ...
                <div class=""mb-3 star"">
                    ...
                    <select class=""form-control"" id=""formDepartment"" placeholder=""Sở GTVT"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "01ee5ff27ab1834e1f9e716789880a4061bbc14d10556", async() => {
                WriteLiteral("Chọn sở GTVT");
            }
            );
            __Microsoft_AspNetCore_Mvc_TagHelpers_OptionTagHelper = CreateTagHelper<global::Microsoft.AspNetCore.Mvc.TagHelpers.OptionTagHelper>();
...
#nullable restore
#line 149 "D:\BA_Work\BA_API\BA_API\Views\DanhMuc\VanTai.cshtml"
...
#nullable disable
            ...
            callApi(`${REP_URL}company?departmentid=${department}&companyid=${transportUnit}&index=${index}`, null, ""GET"", function (item) {
                ...
                if (item.data.length > 0) {
                    item.data.forEach(function (pro) {
                        ...
                        res += `<td class=""text-left"">${pro.address}</td>`;
                        res += `<td class=""text-left"">${pro.department_name}</td>`;
                   ");
            WriteLiteral(@"     res += `<td class=""text-right"">${pro.phone = pro.phone !== null ? pro.phone : """"}</td>`;
    ...
    function loadDVVT(departmentId, companyId) {
        try {
            callApi(`${REP_URL}company/department/${departmentId}`, null, ""GET"", function (obj) {
                let res = ""<option value='0'>Chọn đơn vị vận tải</op");
            WriteLiteral(@"tion>"";
                obj.forEach(function (pro) {
                    res += `<option value=""${pro.id}"">${pro.name}</option>`;
                });
    ...
    function clearBeforeSave() {
        ...
        callApi(`${REP_URL}department/all`, null, ""GET"", function (obj) {
            let res = ""<option value='0'>Chọn sở GTVT</opti");
            WriteLiteral(@"on>"";
            obj.forEach(function (pro) {
                res += `<option value=""${pro.id}"">${pro.name}</option>`;
            });
 ...
 ");
            WriteLiteral(@"       let phone = $(""#formPhone"").val();
        let fax = $(""#formFax"").val();
        ...
        var obj = {""id"": id,""name"": company,""departmentId"": department,""taxId"": tax,""address"": address,""phone"": phone,""email"": email,""fax""");
            WriteLiteral(@": fax,""website"": web}
    ...
    function loadData(id) {
        if (id !== """") {
            ...
            $(""#formEmail"").val("""");
            $(""#formWeb"").val("""");
            callApi(`${REP_URL}company/${id}`, null, ""GET"", function (item) {
                $(""#id"").val(item.id);
    ...
    function showDelete(id) {
        ...
        interval = setInterval(function () {
            ...
            if (timer < 1) {
                ...
                callApi(`${REP_URL}company/${id}`, null, ""DELETE"", function (res) {
                    //$.notify(""Xóa thành công"", ""success"");
                });
                document.getElementById(""msg"").innerHTML = ""Đ");
            WriteLiteral(@"ã xóa"";
                setTimeout(function () {
