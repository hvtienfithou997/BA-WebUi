#pragma checksum "D:\BA_Work\BA_API\BA_API\Views\QuanTriHeThong\NhatKyTruyCap.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "b3b4d3d62415cd66b7f22128e817851d2f5e07e5"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"b3b4d3d62415cd66b7f22128e817851d2f5e07e5", @"/Views/QuanTriHeThong/NhatKyTruyCap.cshtml")]
...
#nullable disable
    ...
    function showResult(index) {
        ...
        window.history.pushState(window.location.href, ""Nhật ký truy cập"", `?username=${username}&start=${start}&end=${end}&index=${index}`);
        
        callApi(`${REP_URL}user/log?username=${use");
            WriteLiteral(@"rname}&start=${start}&end=${end}&index=${index}`, null, ""GET"", function (item) {
            if (item.records > 0) {
                ...
                item.data.forEach(function (pro) {
                    ...
                    res += `<td class=""text-left"">${pro.statusCode === 200 ? ""<span class='text-success'>Thành công<span>"" : ""<span class='text-success'>Không thành công<span>""}</td>`;
                    res += ""</tr>"";
                    count++");
            WriteLiteral(@";
                });
