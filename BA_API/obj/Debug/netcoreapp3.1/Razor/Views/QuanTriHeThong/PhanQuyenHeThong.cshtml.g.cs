#pragma checksum "D:\BA_Work\BA_API\BA_API\Views\QuanTriHeThong\PhanQuyenHeThong.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "4c87f64a7f364ce3e6287f1ccbda63dac948d7d7"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"4c87f64a7f364ce3e6287f1ccbda63dac948d7d7", @"/Views/QuanTriHeThong/PhanQuyenHeThong.cshtml")]
            ...
            <div class=""row"">
                <div class=""form-group col-xl-4 col-lg-6"">
                    ...
                    <select class=""form-control"" id=""inputRole"" placeholder=""Chọn nhóm người dùng"">
                        ");
            __tagHelperExecutionContext = __tagHelperScopeManager.Begin("option", global::Microsoft.AspNetCore.Razor.TagHelpers.TagMode.StartTagAndEndTag, "4c87f64a7f364ce3e6287f1ccbda63dac948d7d74434", async() => {
...
<script>
    ...
    callApi(`${REP_URL}roles?name=`, null");
            ...
            arr.forEach((parent) => {
                ...
                arrChild.forEach((child) => {
                    if (child.featureParentId === parent.featureId) {
                        html += `</tr>`;
        ");
            WriteLiteral(@"                html += `<tr><td colspan=""12"" class=""hiddenRow""><div class=""accordian-body collapse"" id=row-${stt}>`;
                        ...
                        item.forEach((child3) => {
                            if (child3.featureParentId === child.featureId) {
                                html += `</div></td></tr>`;
                                html += `<tr><td colspan=""12"" class=""hiddenRow""><div class=""acco");
            WriteLiteral(@"rdian-body collapse"" id=row-${stt + 10}>`;
    ...
    $(document).on('click', "".menu-level-1"", function () {
        var _parent");
            WriteLiteral(@" = $(this); //input hiện tại
