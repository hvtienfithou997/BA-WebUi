#pragma checksum "D:\BA_Work\BA_API\BA_API\Views\BaoCaoTongHop\LichSuHinhAnhLaiXe.cshtml" "{ff1816ec-aa5e-4d10-87f7-6f4963833460}" "7eb4eacb17026cdf8943331b8ad51b14cfa74883"
// <auto-generated/>
...
#line hidden
#nullable disable
    [global::Microsoft.AspNetCore.Razor.Hosting.RazorSourceChecksumAttribute(@"SHA1", @"7eb4eacb17026cdf8943331b8ad51b14cfa74883", @"/Views/BaoCaoTongHop/LichSuHinhAnhLaiXe.cshtml")]
...
<script>
    ...
    $(function () {
        ...
        $('#report2 tbody').on('click', 'tr', function () {
            ...
            var lat");
            WriteLiteral(@" = $(this).attr(""data-latitude"");
    ...
    function showMap(lat, lng, urlImg) {
        ...
        L.tileLayer('https://api.mapbox.com/styles/v1/{id}/tiles/{z}/{x}/{y}?access_token=pk.eyJ1IjoibXJ0aWVuMDIzIiwiYSI");
            WriteLiteral(@"6ImNrcDR4NW1oaDBnaWEyd3MxMnhtcnFjMjEifQ.s2ANDHDH7Fsdtiy9MN1AQA', {
...
#nullable disable
            WriteLiteral(";\r\n    var index = \'");
#nullable restore
#line 206 "D:\BA_Work\BA_API\BA_API\Views\BaoCaoTongHop\LichSuHinhAnhLaiXe.cshtml"
            Write(ViewBag.index);
